...
Rectangulo::Rectangulo(b2World* mundo, float x,float y, float base,float altura, string color,float rotacion, float masa, bool estatico):Figura(mundo,x,y,color,rotacion,estatico){
	
	this->datos.ancho = base;
	...
	rectanguloFixDef.density = this->calcularDensidad();

	body->CreateFixture(&rectanguloFixDef);
