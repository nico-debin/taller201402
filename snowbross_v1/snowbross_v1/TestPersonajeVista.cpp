...
void TestPersonajeVista::test(){
	...
	eventoPersonaje.id     = 3; // Este valor debe ser unico y definido por el servidor
	...
	SnowBoyVista snowBoy(eventoPersonaje);
	...
	controladorCliente.personajeId = snowBoy.getId();
