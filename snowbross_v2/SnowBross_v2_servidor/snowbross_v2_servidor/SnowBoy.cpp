...
void SnowBoy::setearEstado(float distanciaAlPiso){
	...
	if((izqPresionado||derPresionado) && (this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO)){
		if (izqPresionado){this->estado=EVENTO_CLIENTE_PERSONAJE_CAMINANDO_IZQ;}
		else{this->estado=EVENTO_CLIENTE_PERSONAJE_CAMINANDO_DER;}
	}
	...
	*/
	if ((this->estado==EVENTO_CLIENTE_PERSONAJE_SALTANDO || this->estado==EVENTO_CLIENTE_PERSONAJE_SALTANDO_IZQ || this->estado==EVENTO_CLIENTE_PERSONAJE_SALTANDO_DER )&&(distanciaAlPiso<SNOWBOY_FLOTACION_DESEADA)){this->estado=EVENTO_CLIENTE_PERSONAJE_QUIETO;}
	if (saltarPresionado){this->estado=EVENTO_CLIENTE_PERSONAJE_SALTANDO;}
	if ((saltarPresionado)&&(izqPresionado||derPresionado)){
		if (izqPresionado){this->estado=EVENTO_CLIENTE_PERSONAJE_SALTANDO_IZQ;}
		else {this->estado=EVENTO_CLIENTE_PERSONAJE_SALTANDO_DER;}
	}
	...
	if((izqPresionado||derPresionado) && (this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO && this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO_IZQ && this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO_DER)){
		if (izqPresionado){this->estado=EVENTO_CLIENTE_PERSONAJE_CAMINANDO_IZQ;}
		else {this->estado=EVENTO_CLIENTE_PERSONAJE_CAMINANDO_DER;}
	}
	if((!saltarPresionado && !izqPresionado && !derPresionado) && (this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO && this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO_IZQ && this->estado!=EVENTO_CLIENTE_PERSONAJE_SALTANDO_DER )){this->estado=EVENTO_CLIENTE_PERSONAJE_QUIETO;}
